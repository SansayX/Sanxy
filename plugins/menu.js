let handler  = async (m, { conn, usedPrefix: _p }) => {
  let preview = {}
  try {
    if (!conn.menu) preview = await conn.generateLinkPreview('Tsaniansyah XD')
  } catch (e) {
    try {
...
║
╠═〘 IKLAN 〙 ═
╠➥ Facebook: Ari Fajar Mardana (Tsani)
╠➥ Whangsaf: +6285793933473
║
╠═〘 Info Bot 〙 ═
╠➥ Name : NFQ BOT
╠➥ Coded using *Nano* on Android \\w Termux
╠➥ Request? Wa.me/6285793933473
╠═════
║ Advanced:
║  > return m
║
